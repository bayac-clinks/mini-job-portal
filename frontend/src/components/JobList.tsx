...
const JobList: React.FC<JobListProps> = ({ job, onDelete }) => {
    ...
    const [cardWidth, setCardWidth] = useState<number>(300); // 初期カード幅は300px（画面幅によって変更）
    ...
    return (
        <>
        <div className="p-4 bg-white shadow-md border border-gray-200 rounded-lg mb-4 hover:shadow-lg transform transition-all duration-200 flex flex-col justify-between break-words whitespace-pre-wrap" style={{ width: `${cardWidth}px`,}}>
            ...
            <div className="flex-grow mt-2">
                ...
                <p className="text-gray-700 text-sm mt-1 break-words whitespace-pre-wrap">
                    ...
                    {job.description.length > 100 && (
                        <div onClick={() => setIsExpanded(!isExpanded)} className="text-blue-500 underline ml-2 cursor-pointer" role="button" >
